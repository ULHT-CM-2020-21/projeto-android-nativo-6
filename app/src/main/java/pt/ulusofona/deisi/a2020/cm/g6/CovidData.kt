...
class CovidData {
    ...
    private fun getData() {
        ...
        confirmados_arsnorte = DataSource().getConfirmados_arsnorte(dataPublicacao)
        confirmados_arscentro = DataSource().getConfirmados_arscentro(dataPublicacao)
        confirmados_arslvt = DataSource().getConfirmados_arslvt(dataPublicacao)
        confirmados_arsalentejo = DataSource().getConfirmados_arsalentejo(dataPublicacao)
        confirmados_arsalgarve = DataSource().getConfirmados_arsalgarve(dataPublicacao)
        confirmados_acores = DataSource().getConfirmados_acores(dataPublicacao)
        confirmados_madeira = DataSource().getConfirmados_madeira(dataPublicacao)
        confirmados_novos = DataSource().getConfirmados_novos(dataPublicacao)
        ...
        novos_recuperados = DataSource().getNovos_recuperados(dataPublicacao)
        novos_internados = DataSource().getNovos_internados(dataPublicacao)
        novos_confirmados_arsnorte = DataSource().getNovos_confirmados_arsnorte(dataPublicacao)
        novos_confirmados_arscentro = DataSource().getNovos_confirmados_arscentro(dataPublicacao)
        novos_confirmados_arslvt = DataSource().getNovos_confirmados_arslvt(dataPublicacao)
        novos_confirmados_arsalentejo = DataSource().getNovos_confirmados_arsalentejo(dataPublicacao)
